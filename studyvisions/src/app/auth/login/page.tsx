      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white rounded-3xl shadow-xl border border-[var(--sv-border)] p-8 md:p-10">
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <span className="text-xs text-[var(--sv-text-muted)] uppercase tracking-wider font-medium">
              Or
            </span>
            <div className="flex-1 h-px bg-[var(--sv-border)]" />
          </div>
          ...
          <form action={formAction} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-11 pr-4 py-3 rounded-xl border-2 border-[var(--sv-border)] focus:border-[var(--sv-primary)] focus:outline-none focus:ring-2 focus:ring-blue-100 text-sm transition-all"
                  id="login-email"
                  required
                />
              </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  name="password"
                  placeholder="••••••••"
                  className="w-full pl-11 pr-12 py-3 rounded-xl border-2 border-[var(--sv-border)] focus:border-[var(--sv-primary)] focus:outline-none focus:ring-2 focus:ring-blue-100 text-sm transition-all"
                  id="login-password"
                  required
                />
                <button
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 text-sm">
                <input
                  type="checkbox"
                  className="w-4 h-4 rounded border-slate-300 text-[var(--sv-primary)] focus:ring-[var(--sv-primary)]"
                />
                <span className="text-slate-600">Remember me</span>
              </label>
              <Link
                href="/auth/forgot-password"
                className="text-sm text-[var(--sv-primary)] hover:underline font-medium"
              >
                Forgot Password?
              </Link>
            </div>
            ...
            <button
              type="submit"
              disabled={isPending}
              className="btn-primary w-full !py-3 text-center text-sm disabled:opacity-70"
              id="login-submit"
            >
          ...
          <p className="text-center text-sm text-[var(--sv-text-muted)] mt-6">
            ...
            <Link
              href="/auth/register"
              className="text-[var(--sv-primary)] font-semibold hover:underline"
            >
              Sign Up
            </Link>
          </p>
