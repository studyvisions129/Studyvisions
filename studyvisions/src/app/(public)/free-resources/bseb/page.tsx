      ...
      <div className="bg-[#0b1b42] text-white py-16 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight">BSEB Free Resources</h1>
          </div>
          <p className="text-blue-100 text-lg max-w-2xl">
            Access high-quality study materials, notes, and objective questions for Bihar Board students, completely free of cost.
          </p>
        </div>
      </div>
        ...
        <div>
          <div className="flex items-center justify-between mb-8">
            <h3 className="text-xl font-bold text-slate-800 flex items-center gap-2">
              ...
              {medium === "hindi" ? "Hindi Medium Classes" : "English Medium Classes"}
            </h3>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6">
            {classes.map((className, index) => (
              <Link 
                key={index} 
                href={`#`} // Placeholder link as requested
