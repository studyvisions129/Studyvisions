          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6">
            {courses.map((courseName, index) => {
              const href = courseName === "Arts & Humanities" 
                ...
                ? "/free-resources/ug-courses/medical-and-health-sciences"
                : courseName === "Law"
                ? "/free-resources/ug-courses/law"
                : courseName === "Education"
                ? "/free-resources/ug-courses/education"
                : courseName === "Media & Communication"
                ? "/free-resources/ug-courses/media-and-communication"
                : courseName === "Social Sciences"
                ? "/free-resources/ug-courses/social-sciences"
                : courseName === "Library & Information Science"
                ? "/free-resources/ug-courses/library-and-information-science"
                : courseName === "Agriculture & Allied Sciences"
                ? "/free-resources/ug-courses/agriculture-and-allied-sciences"
                : courseName === "Hotel & Tourism"
                ? "/free-resources/ug-courses/hotel-management-and-tourism"
                : courseName === "Design & Fine Arts"
                ? "/free-resources/ug-courses/design-and-fine-arts"
                : "#";
