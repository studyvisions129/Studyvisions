...
import { BookOpen, GraduationCap, ArrowLeft, Layers, ChevronRight, Library } from "lucide-react";

export default function LibraryAndInformationScienceFreeResources() {
  const [medium, setMedium] = useState<"hindi" | "english">("english");

  const subjects = [
    "B.Lib.I.Sc / BLIS",
    "Library & Information Science related UG programmes"
];
      ...
      <div className="bg-[#0b1b42] text-white py-16 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight">Library & Information Science</h1>
          </div>
          <p className="text-blue-100 text-lg max-w-2xl">
            High-quality free study materials, notes, and resources for various Library & Information Science undergraduate programs.
          </p>
        </div>
      </div>
