...
import { BookOpen, GraduationCap, ArrowLeft, Layers, ChevronRight, Hotel } from "lucide-react";

export default function HotelManagementAndTourismFreeResources() {
  ...
  const subjects = [
    ...
    "Tourism Management",
    "Travel & Tourism",
    "Hospitality-related UG programmes"
];
      ...
      <div className="bg-[#0b1b42] text-white py-16 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight">Hotel Management & Tourism</h1>
          </div>
          <p className="text-blue-100 text-lg max-w-2xl">
            High-quality free study materials, notes, and resources for various Hotel Management & Tourism undergraduate programs.
          </p>
        </div>
      </div>
